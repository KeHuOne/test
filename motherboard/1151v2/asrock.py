...
def get_asrock_1151v2():
    html = get_html("https://market.yandex.ru/catalog--materinskie-platy/55323/list?hid=91020&glfilter=4923171%3A15177871&glfilter=7893318%3A762104&onstock=1&local-offers-first=0")
    if html:
        soup = BeautifulSoup(html, 'lxml')
        all_asrock_1151v2 = soup.find_all('div', class_='n-snippet-card2')
        result = []
        for div in all_asrock_1151v2:
