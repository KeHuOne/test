...
def get_gtx_1660ti():
    html = get_html("https://market.yandex.ru/catalog--videokarty/55314/list?hid=91031&glfilter=4878792%3A16423784&onstock=1&local-offers-first=0&how=aprice")
    if html:
        soup = BeautifulSoup(html, 'lxml')
        all_gtx_1660ti = soup.find_all('div', class_='n-snippet-card2')
        result = []
        for div in all_gtx_1660ti:
