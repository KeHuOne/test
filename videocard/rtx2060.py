...
def get_rtx_2060():
    html = get_html("https://market.yandex.ru/catalog--videokarty/55314/list?hid=91031&glfilter=4878792%3A16307078&onstock=1&local-offers-first=0")
    if html:
        soup = BeautifulSoup(html, 'lxml')
        all_rtx_2060 = soup.find_all('div', class_='n-snippet-card2')
        result = []
        for div in all_rtx_2060:
