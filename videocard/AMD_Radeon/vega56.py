...
def get_vega_56():
    html = get_html("https://market.yandex.ru/catalog--videokarty/55314/list?hid=91031&glfilter=4878792%3A15053046&onstock=1&local-offers-first=0&how=aprice")
    if html:
        soup = BeautifulSoup(html, 'lxml')
        all_vega_56 = soup.find_all('div', class_='n-snippet-card2')
        result = []
        for div in all_vega_56:
