...
def get_rx_570():
    html = get_html("https://market.yandex.ru/catalog--videokarty/55314/list?hid=91031&glfilter=4878792%3A14905752&onstock=1&local-offers-first=0&how=aprice")
    if html:
        soup = BeautifulSoup(html, 'lxml')
        all_rx_570 = soup.find_all('div', class_='n-snippet-card2')
        result = []
        for div in all_rx_570:
